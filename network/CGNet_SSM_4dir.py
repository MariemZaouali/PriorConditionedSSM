# CGNet with Prior-Conditioned Bidirectional State Space (CGNet-SSM v2)
...
class PriorConditionedSSM(nn.Module):
    ...
    def forward(self, F, prior):
        ...
        h_tb = self.scan_forward(x_t, A, Bp).permute(0, 1, 3, 2)
        h_bt = self.scan_backward(x_t, A, Bp).permute(0, 1, 3, 2)
